...
.algorithm-page { min-width: 1180px; min-height: 100vh; display: flex; flex-direction: column; color: #e8f5ff; background: radial-gradient(circle at 50% -20%, #0873bd66, transparent 35%), linear-gradient(135deg, #020f25, #031c38 58%, #03142d); font-family: "Microsoft YaHei", sans-serif; }
