...
.detail-layout { height: 100%; min-height: 0; display: grid; grid-template-columns: clamp(205px, 18vw, 240px) minmax(0,1fr); gap: 7px; overflow: hidden; }.detail-left { display: grid; align-content: stretch; grid-template-rows: auto auto minmax(0,1fr); gap: 7px; min-height: 0; }.detail-main { min-width: 0; min-height: 0; display: grid; grid-template-rows: clamp(62px, 8vh, 76px) minmax(220px,1fr) minmax(260px,.85fr); gap: 7px; }
