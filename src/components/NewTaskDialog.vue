...
.new-task-grid { height: 570px; display: grid; grid-template-columns: 36% 64%; }.task-form { overflow-y: auto; padding: 14px 16px; border-right: 1px solid #0c5174; }.task-form>label,.task-form div>label { display: block; margin: 10px 0 5px; color: #a8d3df; font-size: 11px; }.task-form input:not([type=checkbox]),.task-form select,.task-form textarea { width: 100%; padding: 8px 9px; color: #d8f5fb; background: #03182d; border: 1px solid #155a7e; outline: none; font-size: 10px; }.task-form textarea { height: 64px; resize: none; }.form-columns { display: grid; grid-template-columns: 1fr 1fr; gap: 9px; }.requirement-list { display: grid; grid-template-columns: repeat(4, 1fr); gap: 8px; }.requirement-list label { margin: 0!important; font-size: 9px!important; }.requirement-list input { accent-color: #139dcc; }
.task-range { display: grid; grid-template-rows: 45px 1fr; padding: 14px; }.range-title { display: flex; align-items: center; justify-content: space-between; }.range-title span { color: #678fa1; font-size: 9px; }
