...
/** @deprecated 旧 6 节点占位数据，工作台已改为节点独立组件 */
export const nodeFixtures = {
  'route-flight-plan': { left: ['基础底图', '行政区划', '林地小班', '历史图斑'], right: [['任务面积', '18.6 km²'], ['航线长度', '12.8 km'], ['航点数量', '24 个']], bottom: ['航点列表', '历史航线', '规划告警'] },
  'realtime-cruise': { left: ['开始巡航', '返航', '暂停任务', '云台控制'], right: [['飞行高度', '118 m'], ['水平速度', '8.6 m/s'], ['剩余电量', '72%']], bottom: ['影像缩略图', '飞行日志', '采集统计'] },
